...
def create_dataset(dataset_path, do_train, repeat_num=1, batch_size=128, resize_size=256,
                   crop_size=224, target="GPU", num_threads=4, autoaugment=False, mixup=0.5, num_classes=2388):
    """
